...
import { BookOpen, GraduationCap, List, Type, BookText } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="flex items-center gap-1 overflow-x-auto">
          ...
          <Button variant={location.pathname === "/alphabet" ? "default" : "ghost"} size="sm" asChild>
            <Link to="/alphabet"><Type className="mr-1 h-4 w-4" />Alphabet</Link>
          </Button>
          <Button variant={location.pathname === "/grammar" ? "default" : "ghost"} size="sm" asChild>
